...
# -b $(UPLOAD_RATE)
AVRDUDE_FLAGS = -V -F \
-p $(MCU) -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER) -C /home/pvizi/workspace/arduino/build/linux/dist/tools/avrdude.conf \
-b $(UPLOAD_RATE)
...
CC = /home/pvizi/gcc-avr/usr/bin/avr-gcc
CXX = /home/pvizi/gcc-avr/usr/bin/avr-g++
OBJCOPY = avr-objcopy
OBJDUMP = avr-objdump
AR  = avr-ar
AS = /home/pvizi/gcc-avr/usr/avr/bin/as
SIZE = avr-size
NM = avr-nm
AVRDUDE = /home/pvizi/workspace/arduino/build/linux/dist/tools/avrdude
REMOVE = rm -f
MV = mv -f
